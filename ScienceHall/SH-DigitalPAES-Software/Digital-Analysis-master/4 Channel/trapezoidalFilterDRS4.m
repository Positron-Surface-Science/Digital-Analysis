function [trapezoidalPlateauAverage,vOut,noGood] = trapezoidalFilter(vIn,shapingTypeIn,TFRFIn,TFTopIn)
format long
digits(15)
...
vOut = conv(vIn.y(50:numel(vIn.y)-50),squarePulse);
    ...
    elseif shapingTypeIn == 0
        ...
        [trapezoidalPlateauAverage,vOut,noGood] = MWD(vIn,TFRFIn,TFTopIn);
    ...
    plot(diffGauss);
        ...
        vOut = vOut(100:numel(vOut)-3000)*1000;
    ...
    elseif shapingTypeIn == 7
        ...
        [fitResult, gof] = fitting2(xAxis(round(10E-6/Ts):round(24E-6/Ts)),v);
        gof.adjrsquare
        ...
        elseif abs(gof.adjrsquare) >= 0.99 && amp <= 2
    ...
    elseif shapingTypeIn == 10
        ...
        v = vIn.y(round(10E-6/Ts)+399:round(24E-6/Ts)-59);
        
        assignin('base','vIns',vIn.y(round(10E-6/Ts)+199:round(27E-6/Ts)-571));
