...
for s=1:numberOfPeaks
    ...
    elseif  timingIn == 1 && T ~= 0 && VMinIndex{c}(s) > round(15E-9/dN)
        ...
        if TypeIn == 1 && ggc == 0
            ...
            foundFrac = foundFrac + round(700E-9/dN);
            %foundFraction = horzcat(foundFraction,foundFrac);
        ...
        try
            ...
            if TypeIn == 1 && ggc == 0
                [~, foundFrac1] = min(abs(pulseIny(VMinIndex{c}(s)- ...
                    round((50E-9)/dN):VMinIndex{c}(s)) - VMinFraction1));
                [~, foundFrac2] = min(abs(pulseIny(VMinIndex{c}(s)- ...
                    round((50E-9)/dN):VMinIndex{c}(s)) - VMinFraction2));
                
                foundFrac1 = foundFrac1 + VMinIndex{c}(s) + round(50E-9/dN)
                foundFrac2 = foundFrac2 + VMinIndex{c}(s) + round(50E-9/dN)
                
            else
                
                [~, foundFrac1] = min(abs(pulseIny(VMinIndex{c}(s)-round(700E-9/dN): ...
                    VMinIndex{c}(s)) - VMinFraction1));
                [~, foundFrac2] = min(abs(pulseIny(VMinIndex{c}(s)-round(700E-9/dN): ...
    ...
    elseif (timingIn == 0 || timingIn == 2) && foundFrac1 > round(5E-9/dN) ...
            ...
            foundFrac2 - foundFrac1 <= round(700E-9/dN) && T ~= 0 && ...
