...
layers = [ ...
    ...
    % First Convolution
    convolution2dLayer([2 2], 64, 'Name', 'conv1', 'NumChannels', 1, 'Stride', 2, 'Bias', zeros(1, 1, 64), 'BiasLearnRateFactor', 0)
    batchNormalizationLayer('Name', 'bn1', 'Offset', zeros(1, 1, 64), 'OffsetLearnRateFactor', 0)
    reluLayer('Name', 'relu1')
    maxPooling2dLayer([2 2], 'Name', 'mpling1', 'Stride', 1)

    % Second Convolution
    %convolution2dLayer([4 2], 16, 'Name', 'conv2', 'NumChannels', 8, 'Stride', 2)
    %batchNormalizationLayer('Name', 'bn2')
    %leakyReluLayer('Name', 'relu2')
    %maxPooling2dLayer([2 2], 'Name', 'mpling2', 'Stride', 1)
    ...
    fullyConnectedLayer(numHiddenUnits1, 'Name', 'fc2', 'Bias', zeros(numHiddenUnits1, 1), 'BiasLearnRateFactor', 0)
    ...
    fullyConnectedLayer(numResponses, 'Name', 'fc3', 'Bias', zeros(numResponses, 1), 'BiasLearnRateFactor', 0)
    %dropoutLayer(0.1, 'Name', 'dpo1')
